...
if (Object.keys(colorFunctions).length > 0) {
  test("color-functions.js module exports a function hexToRgb", () => {
    expect(typeof colorFunctions.hexToRgb).toBe("function");
  });

  test("color-functions.js module exports a function rgbToHex", () => {
    expect(typeof colorFunctions.rgbToHex).toBe("function");
  });
  ...
  test('color-functions.js / hexToRgb("ff0000") -> {r: 255, g: 0, b: 0}', () => {
    expect(colorFunctions.hexToRgb("ff0000")).toMatchObject({
      r: 255,
      g: 0,
      b: 0
    });
  ...
  test('color-functions.js / hexToRgb("f00") -> {r: 255, g: 0, b: 0}', () => {
    expect(colorFunctions.hexToRgb("f00")).toMatchObject({
      r: 255,
      g: 0,
      b: 0
    });
  ...
  describe("Instructions", () => {
    test("Module color-functions/src/color-functions.ts must export some things", () => {
